...
<div class="container mt-4">
    ...
    <form method="GET" class="mb-3 row g-2">
        ...
        <div class="col-md-3">
            <button type="submit" class="btn" style="background-color: #CEDDA6">Lihat</button>
        </div>
    </form>
    @if(session('error'))
    ...
    <a href="{{route('salary.download', auth()->user())}}" class="btn mt-3" style="background-color: #CEDDA6">⬇️ Unduh Slip Gaji </a>
</div>
@endsection